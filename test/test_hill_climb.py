...
from vsr_hill_climbing.run import run_vsr_hill_climbing_algorithm, run_vsr_expected_hill_climbing_algorithm
...
ALGORITHMS = {
    "VSR-HILL_CLIMBING": run_vsr_hill_climbing_algorithm,
    "VSR-V2-HILL_CLIMBING": run_vsr_hill_climbing_algorithm,
    "VSR-EXPECTED-HILL_CLIMBING": run_vsr_expected_hill_climbing_algorithm
}
