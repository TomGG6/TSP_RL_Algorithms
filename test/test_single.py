...
ALGORITHMS = {
    ...
    "Q-LKH_S": run_vsr_lkh_algorithm,
    "SARSA-LKH_s": run_vsr_lkh_algorithm,
    "EXPECTED-SARSA_S": run_vsr_lkh_algorithm,
    "MONTECARLO-LKH_S": run_vsr_lkh_algorithm,
    "TD-LKH_S": run_vsr_lkh_algorithm,
    "VSR-LKH_S": run_vsr_lkh_algorithm,
    "VSR-V2-LKH_S": run_vsr_lkh_algorithm,
    "VSR-EXPECTED-LKH_S": run_vsr_expected_lkh_algorithm
}
